...
<div class="row">
    ...
    <div class="one-half column">
        <h3>H2H Toolkit</h3>
        <p>H2H Toolkit is a closed-source continuous monitoring and scanning service, designed to help with large bug bounty programs. It's been in regular development for more than half a year now, and will be open-sourced once fully complete.</p>
    </div>
</div>
